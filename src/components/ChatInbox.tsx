...
export const ChatInbox: React.FC<ChatInboxProps> = ({
  ...
  return (
    <div className="flex-1 flex h-full overflow-hidden bg-slate-950">
      ...
      <div className="w-80 md:w-88 lg:w-96 bg-slate-900 border-r border-slate-800 flex flex-col shrink-0">
        {/* Search & Header */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 flex items-center gap-1.5">
                  ...
                  <span>{selectedLead.formattedPhone}</span>
                  <span>•</span>
                  <span className="text-slate-500">Última msg: {selectedLead.lastInteractionAt}</span>
                </p>
              </div>
            </div>
